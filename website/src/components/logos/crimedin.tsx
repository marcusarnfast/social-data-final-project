...
type CrimedinLogoProps = {
  className?: string
} & React.SVGProps<SVGSVGElement>

/** CrimeIn mark — square tile with network motif (inspired by professional network UI). */
export function CrimedinLogo({ className, ...props }: CrimedinLogoProps) {
  return (
    <svg
      ...
      width={34}
      height={34}
      className={cn("size-[34px] shrink-0 text-primary", className)}
      aria-hidden
      {...props}
    >
      <path
